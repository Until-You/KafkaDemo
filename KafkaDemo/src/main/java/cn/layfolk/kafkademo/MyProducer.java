...
public class MyProducer {
    ...
    static {
        ...
        //自定义分区分配器  默认轮询分区存放，满了写入失败
        //properties.put("partitioner.class", "cn.layfolk.kafkademo.CustomPartitioner");
...
//            ProducerRecord<String, String> record = new ProducerRecord<>("kafka-study", "name", "ForgetResult");
            ProducerRecord<String, String> record = new ProducerRecord<String, String>("kafka-study", Integer.toString(i), Integer.toString(i));
